...
class IPAddressDetector(RegexBasedDetector):
    """Scans for public ip addresses (ipv4)

    Some non-public addresses are ignored, such as:
        - 192.168.
        - 127.
        - 10.
        - 172.(16-31)

    Reference: https://www.iana.org/assignments/ipv4-address-space/ipv4-address-space.xhtml
    """
    secret_type = 'Public IP Address (ipv4)'
