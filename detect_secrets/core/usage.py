...
class ParserBuilder(object):
    ...
    def add_custom_limits(self):
        self.parser.add_argument(
            ...
            nargs=1,
            default=[4.5],
            help='Sets the entropy limit for base64 strings. Value must be between 0.0 and 8.0.'
        )
        self.parser.add_argument(
            '--hex-limit',
            type=argparse_minmax_type,
            nargs=1,
            default=[3],
            help='Sets the entropy limit for hex strings. Value must be between 0.0 and 8.0'
        )
        return self
    ...
    def add_initialize_baseline_argument(self):
        self.parser.add_argument(
            ...
            const='.',
            help=(
                'Scans the entire codebase and outputs a snapshot of currently identified '
                'secrets.'
            )
        )
